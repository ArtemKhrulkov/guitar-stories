      ...
      <v-col cols="12" md="9">
        <div class="d-flex align-center justify-space-between mb-6">
          <h1 class="text-h4 font-weight-bold">
            <IconifyIcon icon="mdi-guitar-electric" color="primary" size="32px" class="mr-2" />
            Guitar Catalog
          </h1>
          <div class="text-body-2 text-medium-emphasis">{{ total }} guitars found</div>
        </div>
        ...
        <!-- Empty State -->
        <v-card v-else-if="guitars.length === 0" class="text-center pa-12">
          <IconifyIcon icon="mdi-guitar-electric" size="64" color="grey" />
        ...
        <!-- Guitars Grid -->
        <v-row v-else>
          <v-col v-for="guitar in guitars" :key="guitar.id" cols="12" sm="6" lg="4">
...
import type { GuitarFilters } from '~/types';
